...
/**
 * Created by claudiatrafton on 6/19/17.
 */
...
public class ParticipantInfoAdapter extends RecyclerView.Adapter<ParticipantInfoAdapter.ViewHolder>{
    ...
    public ParticipantInfoAdapter(ArrayList<Map.Entry<String, String>>  data, Context context){
        this.data = data;
